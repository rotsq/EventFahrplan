...
class FahrplanFragment : Fragment(), SessionViewEventsHandler {
    ...
    private val adapterByRoomIndex: MutableMap<Int, SessionViewColumnAdapter> = HashMap()
    ...
    private fun scrollToCurrent(boxHeight: Int) {
        ...
        if (currentDayIndex != MyApp.dateInfos.indexOfToday) {
            return
        }
        var columnIndex = -1
    ...
    override fun onOptionsItemSelected(menuItem: MenuItem): Boolean {
        if (menuItem.itemId == R.id.menu_item_refresh) {
