...
internal class FahrplanViewModel(
    ...
    val scrollToCurrentParameter = SingleLiveEvent<ScrollToCurrentParameter>()
        ...
        launch {
            ...
            if (sessions.isNotEmpty()) {
                ...
                if (scheduleData.dayIndex == dateInfos.indexOfToday) {
                    val parameter = ScrollToCurrentParameter(scheduleData, dateInfos)
                    scrollToCurrentParameter.postValue(parameter)
                }
            }
        }
    }
